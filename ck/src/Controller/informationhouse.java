...
public class informationhouse extends JFrame{
	...
	public void jframehouse() {
		...
		IDHouse.setForeground(Color.YELLOW);
		lbaddress.setForeground(Color.YELLOW);
		lbarea.setForeground(Color.YELLOW);
		lbdeposits.setForeground(Color.YELLOW);
		lbmax.setForeground(Color.YELLOW);
		lbmember.setForeground(Color.YELLOW);
	...
	public void buttonhouse() {
		...
		btnadd.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				try {
					int record1 = cn.executeDB1("Insert into informationhouse1 values('"+tfIDHouse.getText()+"','"+tfaddress.getText()+"','"+tfarea.getText()+"','"+tfdeposits.getText()+"','"+tfmember.getText()+"','"+tfmax.getText()+"')");
