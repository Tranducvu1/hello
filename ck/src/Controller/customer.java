	...
	public void Customerfind() {
		...
		String column[] = {"IDcustomer", "FullName","Birthday","Gender","HomeTown","PhoneNumber","TimeRental","TimeStart","IDHouse"};	
	    	...
	    	//	pncmndl.setLayout(new GridLayout(1,2));
	    		...
	    		btfind.setBackground(Color.RED);
	    		btupdate.setBackground(Color.RED);
	    		btnew.setBackground(Color.RED);
	    		btdelete.setBackground(Color.RED);
	    		btadd.setBackground(Color.RED);
	    		btsee.setBackground(Color.RED);
	    				 ...
	    				 SimpleDateFormat formatter = new SimpleDateFormat("dd/mm/yyyy");
	    			       ...
	    			       if(rmale.isSelected()) Gender = rmale.getText();
	    					...
	    					java.sql.Date TimeStart = convertUtilToSql(selectedDatestart);
	    					 try {
	    						 ResultSet rs = cn1.ListHouse("Select * from informationhouse1 where IDHouse = '"+tfID.getText()+"' and Member = Member");
