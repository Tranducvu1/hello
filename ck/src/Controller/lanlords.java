	...
	public void buttonlandlord() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ConnectDB1 cn1 = new ConnectDB1();
				 ...
				 Date selectedDate = (Date) dcbirthdayll.getDate();
					...
					//int record1 = cn1.executeDB1("Insert into informationhouse1 values('"+tfIDHouse.getText()+"')");
		...
		btdelete.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				ConnectDB3 cn = new ConnectDB3();
				try {
					int record3 = cn.executeDB3("Delete from landlords where IDlandlords1 = '"+tfCMll.getText()+"' or "
